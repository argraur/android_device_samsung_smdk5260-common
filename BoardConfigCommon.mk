...
# Audio 
BOARD_GLOBAL_CFLAGS += -DSEC_PRODUCT_FEATURE_RIL_CALL_DUALMODE_CDMAGSM # To fix symbol error thats all
...
BOARD_BACK_CAMERA_ROTATION := 180
BOARD_FRONT_CAMERA_ROTATION := 0
BOARD_USE_MHB_ION := false
BOARD_BACK_CAMERA_SENSOR := SENSOR_NAME_S5K3H7_SUNNY
